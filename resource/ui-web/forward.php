      ...
      <div class="modal-footer">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class="fas fa-shield-alt"></i>
            域名与证书
<span class="float-right mt-n1 mb-n2" id="CERbutton" style="display:<?php if ($checkCer === true) echo 'block'; else echo 'none';?>">
<button type="button" id="buttonGenCER" class="btn <?php if ($checkCer === true) echo 'btn-outline-success'; else echo 'btn-outline-secondary';?> btn-sm mt-1" style="border-Radius: 0px;">install</button>
<button type="button" id="buttonCheckCER" class="btn btn-outline-secondary btn-sm mt-1 ml-4" style="border-Radius: 0px;">
  <span id="buttonCheckCERloading"></span>
  <span id="buttonCheckCERtxt">检查证书有效期</span>
</button>
</span>
<span class="float-right mt-n1 mb-n2" id="CERswitch" style="display:<?php if ($checkCer === true) echo 'none'; else echo 'block';?>">
<button type="button" class="btn btn-outline-secondary btn-sm mt-1" style="border-Radius: 0px;" onclick="CERswitch()">展开</button>
</span>
          </div>

          <div class="card-body" id="CERbody" style="display:<?php if ($checkCer === true) echo 'block'; else echo 'none';?>">
    <div class="form-row">
